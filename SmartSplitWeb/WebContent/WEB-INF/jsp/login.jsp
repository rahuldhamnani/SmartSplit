...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
			function onsubmitform()
			{
				...
				document.login.action ='/SmartSplitWeb/userlogin';
  				return true;
			}
			
			function onCreateNew()
			{
				document.forms['login'].action ='/SmartSplitWeb/reg';
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form name='login' method='GET' onsubmit='onsubmitform();' modelAttribute='appUser'>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" id = "email" name="email" /> </div>
                <div class="form-group">
                ...
                <div class="create-account">
                    <p>
<!--                         <input type="button" id="register-btn" class="uppercase" onclick="onCreateNew();" value = "Create an account"/>
 -->                        <a href="#" id="register-btn" class="uppercase" onclick="onCreateNew();">Create an account</a>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
        ...
        <!-- BEGIN CORE PLUGINS -->
<%--         <script src='<c:url value="/assets/javascripts/ValLogin.js" />'></script>
