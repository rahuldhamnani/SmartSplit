...
<html lang="en">
	...
	<form name='error' method='GET'>
        <div class="row">
            <div class="col-md-12 page-500">
                ...
                <div class=" details">
                    <h3 style="color:white;">Oops!Looks like you entered wrong email and password combination.</h3>
                    <p style="color:white;" > Please go back and enter the correct email and password.
                        <br/> </p>
                    <p>
                        <a href="#error" class="btn red btn-outline" onclick="gotologin()"> Return home </a>
                        <br> </p>
                </div>
            </div>
        </div>
    ...
    function gotologin()
    {
    	document.forms['error'].action ='/SmartSplitWeb/mainPage';
		document.forms['error'].submit();
    }
    </script>
