...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="assets/css/font-awesome/css/font-awesome.min.css" />" type="text/css">

    <!-- Plugin CSS -->
    <link rel="stylesheet" href="<c:url value="/resources/stylesheets/animate.min.css" />">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
                ...
                <a  href="/main" class="btn btn-default btn-xl">Get Started!</a>
            </div>
        </div>
    </div>
</section>
...
<aside class="bg-dark">
    <div class="container text-center">
        <div class="call-to-action">
            ...
            <a href="#" class="btn btn-default btn-xl wow tada">Register Now!</a>
        </div>
    </div>
</aside>
