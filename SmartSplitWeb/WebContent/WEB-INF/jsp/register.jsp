...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Smart Split | User Register</title>
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form name='register' id='loginForm'  modelAttribute='users' method='POST' action='/SmartSplitWeb/register' onsubmit='return valReg()'>
                <h3 class="font-green">Sign Up</h3>
                <p class="hint"> Enter your personal details below: </p>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">First Name</label>
                    <input class="form-control placeholder-no-fix" type="text" placeholder="First Name" name="firstName" id="firstName" /> </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Email" id="email" name="email" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="register_password" placeholder="Password" name="password" id="password" /> </div>
        ...
        <!-- BEGIN CORE PLUGINS -->
                <script src='<c:url value="/assets/javascripts/ValRegistration.js" />'></script>
