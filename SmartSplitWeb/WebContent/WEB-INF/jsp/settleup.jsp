...
<title>Smart Split | Settle Up</title>
...
<section>
	...
	<div class="row">
		 	<div class="col-md-12 col-sm-12">
				...
				<tr>
						<p class ="caption-subject font-black bold">You Paid</p>
						<input class ="caption-subject font-black bold" style ="border: none" size="10"  type="text" id="first" readonly="readonly" name="first"/><input class ="caption-subject font-black bold" style ="border: none" type="text" readonly="readonly" id="last" name="last"/>
				</tr>
				<tr>
					<td>Amount:  <input type="text" id="totalAmount" name="totalAmount"/></td>
			   </tr>
			</table>
		</div>
		<input class="btn btn-transparent green btn-outline btn-circle btn-sm active"type="submit" value="Settle up"/>
		</div>
		</div>
		</div>
		</div>
...
{	
	...
	document.forms['settleup'].action = "/SmartSplitWeb/dashboard/friend/settleup/"+newstring;
