		...
		<div id="main-container" class="row">
            <div class="col-md-12 col-sm-12">
                <div class="portlet light ">
					...
					<div class="caption-subject font-black bold uppercase" style="float: left" >You are owed: $</div><div class="caption-subject font-black bold uppercase" id="amtowed" style="float: left"></div><br>
					<div class="caption-subject font-black bold uppercase" style="float: left"> You owe: $</div><div class="caption-subject font-black bold uppercase" id="amtowe" style="float: left"></div>
		<br>
    	<div id="postLoad"></div>
    	</div>
    	</div>
