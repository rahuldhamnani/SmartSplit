...
<div id="main-container">
	<div class="row">
    	...
    	<input  class="btn btn-transparent green btn-outline btn-circle btn-sm active" type="button" onclick="myFunction()" value="Delete Expense"/>
    	</div>
    	</div>
    	</div>
	</div>
  ...
  $(document).ready(function() {
	  var tableData = '<table class="table table-hover table-light"><tr><td>Added By</td><td>category</td><td>title</td><td>amountOwe</td></tr>';
	  	$.each(json.transactions, function(index, data) {
	  	 ...
	  	 tableData += "<tr><td>"+data.firstName+" "+data.lastName+"</td><td>"+data.category+"</td><td>"+data.title+"</td><td>"+data.amountOwe+"</td><td><form method='post' action='transaction/"+data.idTransactions+"'><input type='submit' value='Show Details'/></form></td></tr>";
